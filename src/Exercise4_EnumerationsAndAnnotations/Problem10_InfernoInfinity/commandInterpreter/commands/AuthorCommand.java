 ...
 * All rights reserved!
 */
public class AuthorCommand extends CommandImpl {

    public AuthorCommand(OutputWriter writer, WeaponArchive archive, String[] commandTexts) {
    ...
    public String execute() {
        ...
        this.writer.writeLine("Author: " + annotation.author());

        return "Author printed";
    }
}
