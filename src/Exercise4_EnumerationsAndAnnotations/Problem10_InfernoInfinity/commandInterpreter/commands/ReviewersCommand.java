 ...
 * All rights reserved!
 */
public class ReviewersCommand extends CommandImpl {

    public ReviewersCommand(OutputWriter writer, WeaponArchive archive, String[] commandTexts) {
    ...
    public String execute() {
        ...
        this.writer.writeLine("Reviewers: " + String.join(", ", annotation.reviewers()));

        return "Reviewers printed";
    }
}
